...
def display_banner():
    ...
    # New Stylish ASCII banner for the tool name
    banner = """  
  _____           _                      _             
 |_   _|         | |                    | |            
   | |  _ __  ___| |_ __ _ ___  ___  ___| | _____ _ __ 
   | | | '_ \/ __| __/ _` / __|/ _ \/ _ \ |/ / _ \ '__|
  _| |_| | | \__ \ || (_| \__ \  __/  __/   <  __/ |   
 |_____|_| |_|___/\__\__,_|___/\___|\___|_|\_\___|_|   
                            
                                                                                     
    """

    print(colored(banner, "cyan", attrs=["bold"]))
    print(colored("Created by [Aayush]", "green"))
    print(colored("Instagram:[aayush_3377]", "blue"))
